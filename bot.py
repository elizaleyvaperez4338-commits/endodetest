...
async def get_user_compression_mode(user_id: int) -> str:
    ...
    # Por defecto, modo "before" (procesar con configuración actual)
    return "before"
...
async def cleanup_compression_data(compression_id: str):
    try:
        # Eliminar el registro de downloaded_videos para obtener la ruta del archivo
...
# ======================== NUEVA FUNCIÓN PARA OBTENER NÚMERO SECUENCIAL ======================== #
    ...
    if compression_id in cancel_tasks:
        ...
        try:
            if task_info["type"] == "download":
                ...
                # La eliminación del archivo se maneja en el worker, no aquí
                return True
...
async def get_queue_status(user_id=None):
    try:
        ...
        # ---- Descargas activas (solo una a la vez) ----
        active_downloads = []
...
async def download_file_immediately_worker(compression_id, user_id, chat_id, original_message_id, file_obj, file_name, wait_msg, caption=None, custom_settings=None):
    ...
    try:
        ...
        try:
            ...
            # Descargar usando el nombre único
...
async def compress_video_from_path(task, start_msg):
    ...
    try:
        ...
        file_name = task["file_name"]  # nombre original (sin UUID)
        ...
        msg = await app.send_message(chat_id=chat_id, text=f"   {progress_bar}\n┠ **Velocidad** 0.00B/s\n┠ **Tiempo transcurrido:** 00:00\n┠ **Tiempo restante:** 00:00\n╰━━━━━━━━━━━━━━━━━━╯\n", reply_to_message_id=original_message_id)
        ...
        if original_caption and original_caption.strip():
            # Si el usuario puso una caption, usarla como nombre (sin añadir "_compressed")
    ...
    if data in ["show_plans_from_start", "show_plans_from_video"]:
        ...
        if plan_type == "standard":
            ...
            description = (
                ...
                "• **Precio:** 0.75 USDT💰| 600 Cup💳 | 300 Cup SM📱\n"
                "• **Duración 15 días**\n"
            )
            ...
            description = (
                ...
                "• **Precio:** 1.05 USDT💰| 850 Cup💳 | 425 Cup SM📱\n"
                "• **Duración 30 días**\n"
            )
        else:
